...
const CARTO_CLIENT_ID = process.env.CLIENT_ID;
...
const opts = {
  ...
  pfx: fs.readFileSync(path.join(moduleDir, 'certs/carto.hub.esante.gouv.fr_test.pfx')),
  ...
  passphrase: process.env.CARTO_PASSPHRASE,
