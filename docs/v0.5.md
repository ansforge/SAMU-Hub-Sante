...
- [x] Prise en charge par Spring de la connexion TLS du hub via [`application.properties`](../hub/dispatcher/src/main/resources/application.properties)
- [x] Déclaration des files et exchanges RabbitMQ prise en charge par Spring via [`AmqpConfiguration`](../hub/dispatcher/src/main/java/com/hubsante/hub/config/AmqpConfiguration.java)
