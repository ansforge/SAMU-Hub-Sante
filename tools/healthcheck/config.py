...
CONVERTER_HEALTH_URL = os.getenv("CONVERTER_HEALTH_URL")
ANNUAIRE_HEALTH_URL = os.getenv("ANNUAIRE_HEALTH_URL")
...
DISPATCHER_CONFIG_FILE_PATH = os.getenv("DISPATCHER_CONFIG_FILE_PATH")
