...
from config import HTTP_TIMEOUT, RABBITMQ_HEALTH_URL, RABBITMQ_MONITORING_USERNAME, RABBITMQ_MONITORING_PASSWORD, RABBITMQ_CA_CERT_PATH
...
def rabbitmq_healthcheck():
    try:
        ...
        logging.error("Error occurred on RabbitMQ server's healthcheck: ", exc_info=True)
