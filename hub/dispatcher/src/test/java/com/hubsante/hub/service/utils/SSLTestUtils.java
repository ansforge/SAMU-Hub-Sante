...
public class SSLTestUtils {
    ...
    public static KeyManagerFactory loadClientKey(char[] keyPassphrase, String keyPath)
            throws Exception {
    ...
    public static TrustManagerFactory loadTrustStore(char[] trustPassphrase, String trustStorePath)
            throws Exception {
    ...
    public static SSLContext getSSlContext(String p12Path, String p12Passphrase) throws Exception {
        ...
        TrustManagerFactory tmf =
                loadTrustStore(TRUST_STORE_PASSPHRASE.toCharArray(), TRUST_STORE_PATH);
