...
public class Utils {
    ...
    /*
     * Dans le contexte de ce code exemple, cette méthode permet de récupérer un
     * clientId à partir
    ...
    /*
     * Dans le contexte de ce code exemple, cette méthode permet de récupérer la
     * routing key
    ...
    public static EdxlMessage referenceMessageFromReceivedMessage(EdxlMessage receivedMessage) {
        String referencedMessageRecipient = receivedMessage.getDescriptor().getExplicitAddress()
        ...
        DistributionElement distributionElement = new DistributionElementBuilder(distributionID,
                referencedMessageSender, recipients)
                .kind(DistributionElement.KindEnum.ACK).status(DistributionElement.StatusEnum.SYSTEM).build();
        ReferenceWrapper referenceWrapper = new ReferenceWrapperBuilder(distributionElement,
                referencedMessageDistributionID).build();
